...
def train_dr_MCGibbs(train_data, loss, low_bound = 1e-10, high_bound = 1e5, input_magnitude = 1, output_magnitude = None, k_out_value = 1, anneal_protocol = None, warmup_iters = 2500, goal_accept_rate = 0.44, init_step_size = 2, seed = None, pbar_file = None, verbose=False):
    def rates_to_params(K_fret, k_out):
        idxs = np.triu_indices(num_nodes_sr, 1)
        params = K_fret[idxs]
        return params
